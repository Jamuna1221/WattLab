    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50 flex">
      ...
      <aside className="w-64 bg-white/80 backdrop-blur-lg border-r border-emerald-100 shadow-lg min-h-screen flex flex-col">
        ...
        <nav className="flex-1 p-4">
          <div className="mb-4 pb-4 border-b border-emerald-100 space-y-1">
            <p className="px-4 text-xs font-semibold text-emerald-500 uppercase tracking-wide mb-2">
              Phase 1 — Live data
            </p>
            <Link
              to="/dashboard/live"
              className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-emerald-700 hover:bg-emerald-50 hover:text-emerald-600 transition-all"
            >
              <Activity className="w-5 h-5" />
              <span className="font-medium">Live readings</span>
            </Link>
            <Link
            ...
            >
              ...
              <span className="font-medium">ML &amp; bill</span>
            </Link>
          </div>
